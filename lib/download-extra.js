          ...
          for (let tag of item.tags) {
            ...
            if (ngText.includes(tag.name_en)) {
              if (exFiles.includes(fileName) ||
                ...
                fs.removeSync(path.join(exDir, "image", fileName));
                fs.removeSync(path.join(exDir, "image", "ok", fileName));

                fs.removeSync(path.join(exOkDir, fileName));
                fs.removeSync(path.join(exOkDir, "image", fileName));
                fs.removeSync(path.join(exOkDir, "image", "ok", fileName));

                fs.removeSync(path.join(exNgDir, fileName));
                fs.removeSync(path.join(exNgDir, "video", fileName));
                fs.removeSync(path.join(exNgDir, "video", "ok", fileName));
              }
