          ...
          for (let tag of item.tags) {
            ...
            if (ngText.includes(tag.name_en)) {
              if (exFiles.includes(fileName) ||
                ...
                fs.removeSync(path.join(exFiles, fileName));
                fs.removeSync(path.join(exFiles, "image", fileName));
                fs.removeSync(path.join(exFiles, "image", "ok", fileName));

                fs.removeSync(path.join(exOkFiles, fileName));
                fs.removeSync(path.join(exOkFiles, "image", fileName));
                fs.removeSync(path.join(exOkFiles, "image", "ok", fileName));

                fs.removeSync(path.join(exNgFiles, fileName));
                fs.removeSync(path.join(exNgFiles, "video", fileName));
                fs.removeSync(path.join(exNgFiles, "video", "ok", fileName));
              }
