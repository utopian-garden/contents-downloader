...
const server = http.createServer(async (req, res) => {
  ...
  if (req.method === 'OPTIONS') {
    ...
    switch (reqApi) {
      ...
      case chkDbUri:
        try {
          const dlCount = await ddb.itemCount(reqTag, dlTable);
          const favCount = await ddb.itemCount(reqTag, favTable);
          let resTable = 'None';
        ...
        case addItemUri:
          ...
          switch (reqTable) {
            ...
            case favTable:
              oppTable = dlTable;
              try {
                await ddb.itemUpdate(reqTable, reqTag);
                await ddb.itemDelete(oppTable, reqTag);
              ...
              await sqs.sendMsg(priorFavQueUrl, reqTag);
            ...
            case dlTable:
              ...
              await sqs.sendMsg(priorDlQueUrl, reqTag);
