        ...
        case addItemUri:
          ...
          switch (reqTable) {
            ...
            case favTable:
              ...
              const tagImageDir = path.join(appConfig.fs.dlImageDir, sanitize(reqTag));
              const tagImageOkDir = path.join(appConfig.fs.dlImageOkDir, sanitize(reqTag));
              const tagVideoDir = path.join(appConfig.fs.dlVideoDir, sanitize(reqTag));
              const tagVideoOkDir = path.join(appConfig.fs.dlVideoOkDir, sanitize(reqTag));
