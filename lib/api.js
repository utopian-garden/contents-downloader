...
require('console-stamp-color')(console, { pattern: 'yyyy/mm/dd HH:MM:ss' });
          ...
          case addItemUri:
            ...
            switch (reqTable) {
              ...
              case favTable:
                ...
                try {
                  await ddb
                    .addItem(reqTable, reqTag)
                    .deleteItem(oppTable, reqTag);
                ...
                try {
                  fs
                    .removeSync(tagImageDir)
                    .removeSync(tagImageOkDir)
                    .removeSync(tagVideoDir)
                    .removeSync(tagVideoOkDir);
                } catch(err) {
                  console.error('addItemUri', err.message);
                  logger.error('addItemUri', err.message);
                }
