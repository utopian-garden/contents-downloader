  ...
  for (let param of params) {
    ...
    for (let targetTag of targetTags) {
      ...
      if (fixedTargetTag) {
        ...
        logger.debug(toTable, search.chanSearchUrl + targetTag +
          search.chanSearchParam, path.join(targetDir, targetTag));
      }
    }
    ...
    for (let oppoTag of oppoTags) {
      ...
      if (wrongOppoTag) {
        ...
        logger.debug(fromTable, search.chanSearchUrl + oppoTag +
          search.chanSearchParam, path.join(oppoDir, oppoTag));
      }
    }
  }
